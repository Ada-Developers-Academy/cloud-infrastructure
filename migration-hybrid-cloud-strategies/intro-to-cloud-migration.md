...
Cloud migration shifts physical infrastructure responsibility — buildings, power, cooling, hardware — to the cloud provider. However, the organization retains responsibility for what runs on top of that infrastructure: their application code, data, access controls, and configuration. The cloud does not manage what you build on it.
