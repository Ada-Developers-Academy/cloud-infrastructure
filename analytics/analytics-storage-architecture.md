...
This following table summarizes some of the core differences between data warehouses and data lakes.
...
| **Metadata Location** |	**Internal Schema:** The database engine owns and manages the metadata and the files together. | **External Catalog:** Metadata is a separate "instruction manual" that tells engines how to read raw files. |
